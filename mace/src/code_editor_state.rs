...
pub struct CodeEditorState {
    pub session_id_allocator: IdAllocator,
    pub sessions_by_session_id: IdMap<SessionId, Session>,
    pub document_id_allocator: IdAllocator,
    pub documents_by_document_id: IdMap<DocumentId, Document>,
    pub document_ids_by_path: HashMap<PathBuf, DocumentId>,
    pub document_ids_by_file_id: IdMap<FileId, DocumentId>,
